(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))e(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const p of n.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&e(p)}).observe(document,{childList:!0,subtree:!0});function a(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function e(s){if(s.ep)return;s.ep=!0;const n=a(s);fetch(s.href,n)}})();const X=window.fetch;let O=null,B=!1;const st=window.location.pathname.split("/"),at=()=>{if(window.location.hostname.includes("github.io")){const t=st[1];return t?`/${t}`:""}return""},Y=at();function K(t){if(!t)return"";if(t.startsWith("http://")||t.startsWith("https://")||t.startsWith("data:"))return t;const i=t.startsWith("/")?t:"/"+t;return`${Y}${i}`}function E(t){if(!t)return t;if(typeof t=="string")return t.startsWith("/uploads/")?K(t):t;if(Array.isArray(t))return t.map(i=>E(i));if(typeof t=="object"){const i={};for(const a in t)i[a]=E(t[a]);return i}return t}async function nt(){if(window.location.hostname.includes("github.io")){B=!0,console.log("[API Mode] GitHub Pages detected. Using LocalStorage Mock API.");return}try{(await X("/api/health")).ok?(B=!1,console.log("[API Mode] Backend connected. Using live API.")):(B=!0,console.log("[API Mode] Backend responded with error. Falling back to LocalStorage Mock API."))}catch{B=!0,console.log("[API Mode] Backend unreachable. Falling back to LocalStorage Mock API.")}}function rt(){return O||(O=nt()),O}const ot=[{id:1,name:"The Chillwaves",bio:"Cool and relaxing ambient vibes for study and relaxation.",image_url:"/uploads/images/the_chillwaves.svg"},{id:2,name:"Syntax Error",bio:"Energetic synthwave and techno tracks made by coders, for coders.",image_url:"/uploads/images/syntax_error.svg"},{id:3,name:"Midnight Beats",bio:"Lofi, jazz hop, and downtempo rhythms for late-night thoughts.",image_url:"/uploads/images/midnight_beats.svg"}],lt=[{id:1,title:"Ocean Breeze",cover_url:"/uploads/images/ocean_breeze.svg",artist_id:1,artist_name:"The Chillwaves",release_year:2024},{id:2,title:"Dark Mode",cover_url:"/uploads/images/dark_mode.svg",artist_id:2,artist_name:"Syntax Error",release_year:2023},{id:3,title:"Neon City",cover_url:"/uploads/images/neon_city.svg",artist_id:3,artist_name:"Midnight Beats",release_year:2025}],dt=[{id:1,title:"Lost in the Waves",duration:180,song_url:"/uploads/audio/lost_in_the_waves.mp3",album_id:1,album_title:"Ocean Breeze",artist_id:1,artist_name:"The Chillwaves",cover_url:"/uploads/images/ocean_breeze.svg"},{id:2,title:"Summer Lounge",duration:210,song_url:"/uploads/audio/summer_lounge.mp3",album_id:1,album_title:"Ocean Breeze",artist_id:1,artist_name:"The Chillwaves",cover_url:"/uploads/images/ocean_breeze.svg"},{id:3,title:"Compile Success",duration:150,song_url:"/uploads/audio/compile_success.mp3",album_id:2,album_title:"Dark Mode",artist_id:2,artist_name:"Syntax Error",cover_url:"/uploads/images/dark_mode.svg"},{id:4,title:"Infinite Loop",duration:240,song_url:"/uploads/audio/infinite_loop.mp3",album_id:2,album_title:"Dark Mode",artist_id:2,artist_name:"Syntax Error",cover_url:"/uploads/images/dark_mode.svg"},{id:5,title:"Traffic Lights",duration:195,song_url:"/uploads/audio/traffic_lights.mp3",album_id:3,album_title:"Neon City",artist_id:3,artist_name:"Midnight Beats",cover_url:"/uploads/images/neon_city.svg"},{id:6,title:"Rainy Streets",duration:220,song_url:"/uploads/audio/rainy_streets.mp3",album_id:3,album_title:"Neon City",artist_id:3,artist_name:"Midnight Beats",cover_url:"/uploads/images/neon_city.svg"}];let v=null;function ct(){if(v)return;const t=localStorage.getItem("spotify_clone_mock_db");t?v=JSON.parse(t):(v={users:[{id:1,username:"demo",email:"demo@demo.com",password:"password123"}],artists:ot,albums:lt,songs:dt,likedSongs:{demo:[1,3,5]},playlists:[{id:101,name:"Chill Vibes Mix",description:"A selection of the finest relaxing beats.",owner:"demo",cover_url:"/uploads/images/ocean_breeze.svg",song_ids:[1,2,5]}]},I())}function I(){localStorage.setItem("spotify_clone_mock_db",JSON.stringify(v))}function $(){const t=sessionStorage.getItem("spotify_clone_current_user")||localStorage.getItem("spotify_clone_current_user");return t?JSON.parse(t):null}function G(t){sessionStorage.setItem("spotify_clone_current_user",JSON.stringify(t)),localStorage.setItem("spotify_clone_current_user",JSON.stringify(t))}function ut(){sessionStorage.removeItem("spotify_clone_current_user"),localStorage.removeItem("spotify_clone_current_user")}function pt(t,i={}){const a=new URL(t,window.location.origin),e=a.pathname.replace(Y,""),s=(i.method||"GET").toUpperCase(),n=i.body?JSON.parse(i.body):null,p=(r,d=200)=>new Response(JSON.stringify(r),{status:d,headers:{"Content-Type":"application/json"}}),y=(r,d=400)=>new Response(JSON.stringify({error:r}),{status:d,headers:{"Content-Type":"application/json"}});if(ct(),e==="/api/health")return p({status:"OK",message:"Spotify Clone Mock API is running"});if(e==="/api/auth/me"){const r=$();return r?p({user:r}):y("Not authenticated",401)}if(e==="/api/auth/login"&&s==="POST"){const{email:r,password:d}=n,u=v.users.find(f=>(f.email===r||f.username===r)&&f.password===d);return u?(G(u),p({message:"Login successful",user:{id:u.id,username:u.username,email:u.email}})):y('Invalid credentials. (Hint: Try username "demo" and password "password123")',401)}if(e==="/api/auth/register"&&s==="POST"){const{username:r,email:d,password:u}=n;if(v.users.some(S=>S.email===d||S.username===r))return y("Username or email already exists");const f={id:Date.now(),username:r,email:d,password:u};return v.users.push(f),I(),G(f),p({message:"Registration successful",user:{id:f.id,username:f.username,email:f.email}})}if(e==="/api/auth/logout"&&s==="POST")return ut(),p({message:"Logout successful"});if(e==="/api/songs"&&s==="GET")return p(E(v.songs));if(e==="/api/songs/albums"&&s==="GET")return p(E(v.albums));if(e==="/api/songs/artists"&&s==="GET")return p(E(v.artists));const x=e.match(/^\/api\/songs\/albums\/(\d+)$/);if(x&&s==="GET"){const r=parseInt(x[1]),d=v.albums.find(f=>f.id===r);if(!d)return y("Album not found",404);const u=v.songs.filter(f=>f.album_id===r);return p(E({album:d,songs:u}))}const l=e.match(/^\/api\/songs\/artists\/(\d+)$/);if(l&&s==="GET"){const r=parseInt(l[1]),d=v.artists.find(S=>S.id===r);if(!d)return y("Artist not found",404);const u=v.songs.filter(S=>S.artist_id===r),f=v.albums.filter(S=>S.artist_id===r);return p(E({artist:d,songs:u,albums:f}))}if(e.startsWith("/api/songs/search")&&s==="GET"){const d=(a.searchParams.get("q")||"").toLowerCase(),u=v.songs.filter(L=>L.title.toLowerCase().includes(d)||L.artist_name.toLowerCase().includes(d)||L.album_title.toLowerCase().includes(d)),f=v.albums.filter(L=>L.title.toLowerCase().includes(d)||L.artist_name.toLowerCase().includes(d)),S=v.artists.filter(L=>L.name.toLowerCase().includes(d));return p(E({songs:u,albums:f,artists:S}))}if(e==="/api/liked/ids"&&s==="GET"){const r=$();if(!r)return y("Not authenticated",401);const d=v.likedSongs[r.username]||[];return p(d)}if(e==="/api/liked"&&s==="GET"){const r=$();if(!r)return y("Not authenticated",401);const d=v.likedSongs[r.username]||[],u=v.songs.filter(f=>d.includes(f.id));return p(E(u))}if(e==="/api/liked"&&s==="POST"){const r=$();if(!r)return y("Not authenticated",401);const{songId:d}=n;return v.likedSongs[r.username]||(v.likedSongs[r.username]=[]),v.likedSongs[r.username].includes(d)||(v.likedSongs[r.username].push(d),I()),p({success:!0})}const m=e.match(/^\/api\/liked\/(\d+)$/);if(m&&s==="DELETE"){const r=$();if(!r)return y("Not authenticated",401);const d=parseInt(m[1]);return v.likedSongs[r.username]&&(v.likedSongs[r.username]=v.likedSongs[r.username].filter(u=>u!==d),I()),p({success:!0})}if(e==="/api/playlists"&&s==="GET"){const r=$();if(!r)return y("Not authenticated",401);const d=v.playlists.filter(u=>u.owner===r.username);return p(E(d))}if(e==="/api/playlists"&&s==="POST"){const r=$();if(!r)return y("Not authenticated",401);const{name:d,description:u}=n,f=["/uploads/images/ocean_breeze.svg","/uploads/images/dark_mode.svg","/uploads/images/neon_city.svg"],S=f[Math.floor(Math.random()*f.length)],L={id:Date.now(),name:d,description:u||"",owner:r.username,cover_url:S,song_ids:[]};return v.playlists.push(L),I(),p(E(L))}const h=e.match(/^\/api\/playlists\/(\d+)$/);if(h){const r=parseInt(h[1]),d=v.playlists.find(u=>u.id===r);if(!d)return y("Playlist not found",404);if(s==="GET"){const u=v.songs.filter(f=>d.song_ids.includes(f.id));return p(E({playlist:d,songs:u}))}if(s==="PUT"){const{name:u,description:f}=n;return d.name=u,d.description=f||"",I(),p(E(d))}if(s==="DELETE")return v.playlists=v.playlists.filter(u=>u.id!==r),I(),p({success:!0})}const w=e.match(/^\/api\/playlists\/(\d+)\/songs$/);if(w&&s==="POST"){const r=parseInt(w[1]),{songId:d}=n,u=v.playlists.find(f=>f.id===r);return u?u.song_ids.includes(d)?y("Song already exists in this playlist"):(u.song_ids.push(d),I(),p({success:!0})):y("Playlist not found",404)}const c=e.match(/^\/api\/playlists\/(\d+)\/songs\/(\d+)$/);if(c&&s==="DELETE"){const r=parseInt(c[1]),d=parseInt(c[2]),u=v.playlists.find(f=>f.id===r);return u?(u.song_ids=u.song_ids.filter(f=>f!==d),I(),p({success:!0})):y("Playlist not found",404)}return y("Mock endpoint not found",404)}window.fetch=async function(t,i={}){if(await rt(),typeof t=="string"&&t.includes("/uploads/")&&(t=K(t)),B&&typeof t=="string"&&t.includes("/api/"))return pt(t,i);const a=await X(t,i);if(a.ok&&typeof t=="string"&&t.includes("/api/")){const e=a.clone();try{const s=await e.json(),n=E(s);return new Response(JSON.stringify(n),{status:a.status,statusText:a.statusText,headers:a.headers})}catch{}}return a};class q{constructor(){this.audio=new Audio,this.playlist=[],this.currentIndex=-1,this.isPlaying=!1,this.isShuffle=!1,this.isRepeat="none",this.originalPlaylist=[],this.volume=.7,this.audio.volume=this.volume,this.isMuted=!1,this.onTrackChange=null,this.onPlayStateChange=null,this.onTimeUpdate=null,this.onQueueEnd=null,this.initAudioListeners()}initAudioListeners(){this.audio.addEventListener("timeupdate",()=>{if(this.onTimeUpdate&&this.audio.duration){const i=this.audio.currentTime,a=this.audio.duration,e=i/a*100;this.onTimeUpdate(i,a,e)}}),this.audio.addEventListener("ended",()=>{this.handleSongEnded()}),this.audio.addEventListener("error",i=>{console.error("Audio playback error:",i),this.isPlaying=!1,this.onPlayStateChange&&this.onPlayStateChange(!1)})}setPlaylist(i,a=0){!i||i.length===0||(this.playlist=[...i],this.originalPlaylist=[...i],this.currentIndex=a,this.isShuffle&&this.shufflePlaylist(a))}loadAndPlayCurrent(){if(this.currentIndex<0||this.currentIndex>=this.playlist.length)return;const i=this.playlist[this.currentIndex];this.audio.src=i.song_url,this.audio.load();const a=this.audio.play();a!==void 0&&a.then(()=>{this.isPlaying=!0,this.onPlayStateChange&&this.onPlayStateChange(!0),this.onTrackChange&&this.onTrackChange(i)}).catch(e=>{console.warn("Playback blocked or failed. User interaction required.",e),this.isPlaying=!1,this.onPlayStateChange&&this.onPlayStateChange(!1)})}playTrack(i,a){if(a&&a.length>0){const e=a.findIndex(s=>s.id===i.id);this.setPlaylist(a,e!==-1?e:0)}else this.setPlaylist([i],0);this.loadAndPlayCurrent()}togglePlay(){this.currentIndex!==-1&&(this.isPlaying?(this.audio.pause(),this.isPlaying=!1):(this.audio.play().catch(()=>{}),this.isPlaying=!0),this.onPlayStateChange&&this.onPlayStateChange(this.isPlaying))}next(){if(this.playlist.length!==0){if(this.isRepeat==="track"){this.audio.currentTime=0,this.audio.play().catch(()=>{});return}if(this.currentIndex++,this.currentIndex>=this.playlist.length)if(this.isRepeat==="playlist")this.currentIndex=0;else{this.currentIndex=this.playlist.length-1,this.isPlaying=!1,this.audio.pause(),this.onPlayStateChange&&this.onPlayStateChange(!1),this.onQueueEnd&&this.onQueueEnd();return}this.loadAndPlayCurrent()}}prev(){if(this.playlist.length!==0){if(this.audio.currentTime>3){this.audio.currentTime=0;return}this.currentIndex--,this.currentIndex<0&&(this.isRepeat==="playlist"?this.currentIndex=this.playlist.length-1:this.currentIndex=0),this.loadAndPlayCurrent()}}toggleShuffle(){if(this.isShuffle=!this.isShuffle,this.playlist.length===0)return this.isShuffle;const i=this.playlist[this.currentIndex];if(this.isShuffle)this.shufflePlaylist(this.currentIndex);else{const a=this.originalPlaylist.findIndex(e=>e.id===i.id);this.playlist=[...this.originalPlaylist],this.currentIndex=a!==-1?a:0}return this.isShuffle}shufflePlaylist(i){const a=this.playlist[i],e=this.playlist.filter((s,n)=>n!==i);for(let s=e.length-1;s>0;s--){const n=Math.floor(Math.random()*(s+1));[e[s],e[n]]=[e[n],e[s]]}this.playlist=[a,...e],this.currentIndex=0}toggleRepeat(){return this.isRepeat==="none"?this.isRepeat="playlist":this.isRepeat==="playlist"?this.isRepeat="track":this.isRepeat="none",this.isRepeat}handleSongEnded(){this.isRepeat==="track"?(this.audio.currentTime=0,this.audio.play().catch(()=>{})):this.next()}seek(i){if(!this.audio.duration)return;const a=i/100*this.audio.duration;this.audio.currentTime=a}setVolume(i){this.volume=Math.max(0,Math.min(1,i)),this.isMuted||(this.audio.volume=this.volume)}toggleMute(){return this.isMuted=!this.isMuted,this.audio.muted=this.isMuted,this.isMuted}static formatTime(i){if(isNaN(i))return"0:00";const a=Math.floor(i/60),e=Math.floor(i%60);return`${a}:${e<10?"0":""}${e}`}}const U=t=>q.formatTime(t),H=t=>`linear-gradient(to bottom, hsl(${t.split("").reduce((e,s)=>e+s.charCodeAt(0),0)%360}, 45%, 25%) 0%, var(--color-dark-gray) 100%)`,gt=()=>{const t=new Date().getHours();return t<12?"Good morning":t<18?"Good afternoon":"Good evening"},yt=(t,i,a)=>{const{albums:e,artists:s,songs:n}=i,{onPlaySong:p,onNavigate:y}=a,x=gt();t.innerHTML=`
  ...
  `,t.querySelectorAll(".music-card").forEach(l=>{l.addEventListener("click",m=>{if(m.target.closest(".card-play-btn"))return;const h=l.dataset.action,w=l.dataset.id;y(h,w)})}),t.querySelectorAll(".quick-play-row").forEach(l=>{l.addEventListener("mouseenter",()=>{const m=l.querySelector(".quick-play-btn");m&&(m.style.opacity="1")}),l.addEventListener("mouseleave",()=>{const m=l.querySelector(".quick-play-btn");m&&(m.style.opacity="0")}),l.querySelector(".click-trigger").addEventListener("click",m=>{const h=m.currentTarget.dataset.targetId;y("album",h)}),l.querySelector(".quick-play-btn").addEventListener("click",m=>{m.stopPropagation();const h=parseInt(m.currentTarget.dataset.songId),w=n.find(c=>c.id===h);w&&p(w,n)})}),t.querySelectorAll(".card-play-btn[data-album-id]").forEach(l=>{l.addEventListener("click",m=>{m.stopPropagation();const h=parseInt(l.dataset.albumId);y("album",h,{autoPlay:!0})})}),t.querySelectorAll(".card-play-btn[data-artist-id]").forEach(l=>{l.addEventListener("click",m=>{m.stopPropagation();const h=parseInt(l.dataset.artistId);y("artist",h,{autoPlay:!0})})})},J=(t,i,a,e)=>{const{onPlaySong:s,onToggleLike:n,likedIds:p,onNavigate:y,onOpenPlaylistMenu:x}=e;if(!a){t.innerHTML=`
    ...
    `;return}const{songs:l,albums:m,artists:h}=i;if(l.length===0&&m.length===0&&h.length===0){t.innerHTML=`
      <div style="height: 60vh; display: flex; flex-direction: column; align-items: center; justify-content: center; color: var(--color-text-muted);">
    ...
    <div style="display: grid; grid-template-columns: 2fr 3fr; gap: 32px; margin-top: 32px;">
      ...
      <div>
        ...
        `:m.length>0?`
          <div class="music-card" style="background-color: var(--color-medium-gray); padding: 24px; border-radius: 8px; width: 100%; height: 260px; display: flex; flex-direction: column; justify-content: flex-end; position: relative;" data-action="album" data-id="${m[0].id}">
            <img src="${m[0].cover_url}" style="width: 92px; height: 92px; border-radius: 6px; box-shadow: 0 8px 24px rgba(0,0,0,0.5); margin-bottom: 24px;" alt="${m[0].title}">
            <div style="font-family: var(--font-header); font-size: 28px; font-weight: 800; color: #fff; margin-bottom: 8px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 100%;">${m[0].title}</div>
            <div style="font-size: 14px; color: var(--color-text-muted); margin-bottom: 8px;">Album • ${m[0].artist_name}</div>
            <button class="card-play-btn" data-album-id="${m[0].id}" style="bottom: 24px; right: 24px;">
              <i class="bx bx-play" style="margin-left: 2px;"></i>
            </button>
          </div>
        `:`
    ...
    `:""}
  `,t.querySelectorAll(".search-song-row").forEach(c=>{const r=parseInt(c.dataset.songId),d=l.find(u=>u.id===r);c.addEventListener("mouseenter",()=>{c.querySelector(".hover-play-icon").style.display="flex"}),c.addEventListener("mouseleave",()=>{c.querySelector(".hover-play-icon").style.display="none"}),c.querySelector(".hover-play-icon").addEventListener("click",u=>{u.stopPropagation(),s(d,l)}),c.querySelector(".song-title-click").addEventListener("click",u=>{u.stopPropagation(),s(d,l)}),c.querySelector(".song-artist-click").addEventListener("click",u=>{u.stopPropagation();const f=u.currentTarget.dataset.artistId;y("artist",f)}),c.querySelector('[data-action="like"]').addEventListener("click",u=>{u.stopPropagation(),n(r)}),c.querySelector('[data-action="add-to-playlist"]').addEventListener("click",u=>{u.stopPropagation(),x(u.currentTarget,r)})});const w=t.querySelector(".music-card");w&&w.addEventListener("click",c=>{if(c.target.closest(".card-play-btn"))return;const r=w.dataset.action,d=w.dataset.id;if(r==="song-play"){const u=parseInt(w.dataset.songId),f=l.find(S=>S.id===u);s(f,l)}else y(r,d)}),t.querySelectorAll(".card-play-btn[data-artist-id]").forEach(c=>{c.addEventListener("click",r=>{r.stopPropagation();const d=parseInt(c.dataset.artistId);y("artist",d,{autoPlay:!0})})}),t.querySelectorAll(".card-play-btn[data-album-id]").forEach(c=>{c.addEventListener("click",r=>{r.stopPropagation();const d=parseInt(c.dataset.albumId);y("album",d,{autoPlay:!0})})}),t.querySelectorAll(".cards-grid .music-card").forEach(c=>{c.addEventListener("click",r=>{if(r.target.closest(".card-play-btn"))return;const d=c.dataset.action,u=c.dataset.id;y(d,u)})})},C=(t,i,a=!1)=>t.length===0?`
  ...
  `,N=(t,i,a,e=!1)=>{const{onPlaySong:s,onToggleLike:n,onNavigate:p,onOpenPlaylistMenu:y,onRemoveSongFromPlaylist:x}=a;t.querySelectorAll(".song-row").forEach(l=>{const m=parseInt(l.dataset.songId),h=i.find(r=>r.id===m);l.querySelectorAll(".td-play-icon, .td-title-name").forEach(r=>{r.addEventListener("click",d=>{d.stopPropagation(),s(h,i)})}),l.querySelector(".td-title-artist").addEventListener("click",r=>{r.stopPropagation();const d=r.currentTarget.dataset.artistId;p("artist",d)}),l.querySelector(".td-album").addEventListener("click",r=>{r.stopPropagation();const d=r.currentTarget.dataset.albumId;p("album",d)}),l.querySelector('[data-action="like"]').addEventListener("click",r=>{r.stopPropagation(),n(m)});const c=l.querySelector('[data-action="add"], [data-action="remove"]');c&&c.addEventListener("click",r=>{r.stopPropagation(),c.dataset.action==="remove"?x(m):y(r.currentTarget,m)})})},mt=(t,i,a)=>{const{album:e,songs:s}=i,{likedIds:n,onPlaySong:p,onNavigate:y}=a,x=H(e.title);t.innerHTML=`
    ...
    <!-- Song Table List -->
    ${C(s,n,!1)}
  `;const l=t.querySelector("#hero-artist-link");l&&l.addEventListener("click",()=>{y("artist",e.artist_id)});const m=t.querySelector("#album-play-btn");m&&s.length>0&&m.addEventListener("click",()=>{p(s[0],s)}),N(t,s,a)},ht=(t,i,a)=>{const{artist:e,albums:s,songs:n}=i,{likedIds:p,onPlaySong:y,onNavigate:x}=a,l=H(e.name);t.innerHTML=`
  ...
  `;const m=t.querySelector("#artist-play-btn");m&&n.length>0&&m.addEventListener("click",()=>{y(n[0],n)}),t.querySelectorAll(".cards-grid .music-card").forEach(h=>{h.addEventListener("click",w=>{if(w.target.closest(".card-play-btn"))return;const c=h.dataset.action,r=h.dataset.id;x(c,r)})}),t.querySelectorAll(".card-play-btn[data-album-id]").forEach(h=>{h.addEventListener("click",w=>{w.stopPropagation();const c=parseInt(h.dataset.albumId);x("album",c,{autoPlay:!0})})}),N(t,n,a)},ft=(t,i,a)=>{const{playlist:e,songs:s}=i,{likedIds:n,onPlaySong:p,onEditPlaylist:y,onDeletePlaylist:x}=a,l=H(e.name),m=s.reduce((M,j)=>M+j.duration,0),h=U(m);t.innerHTML=`
    ...
    ${C(s,n,!0)}
  `;const w=t.querySelector("#playlist-play-btn");w&&s.length>0&&w.addEventListener("click",()=>{p(s[0],s)});const c=t.querySelector("#btn-edit-playlist"),r=t.querySelector("#btn-delete-playlist"),d=t.querySelector("#playlist-title-display"),u=t.querySelector("#playlist-desc-display"),f=t.querySelector("#playlist-edit-form-inline"),S=t.querySelector("#btn-cancel-playlist-details"),L=t.querySelector("#btn-save-playlist-details");c.addEventListener("click",()=>{d.classList.add("hidden"),u.classList.add("hidden"),f.classList.remove("hidden")}),S.addEventListener("click",()=>{d.classList.remove("hidden"),u.classList.remove("hidden"),f.classList.add("hidden")}),L.addEventListener("click",()=>{const M=t.querySelector("#edit-playlist-name-input").value.trim(),j=t.querySelector("#edit-playlist-desc-input").value.trim();M&&y(e.id,M,j)}),r.addEventListener("click",()=>{confirm("Are you sure you want to delete this playlist? This cannot be undone.")&&x(e.id)}),N(t,s,a,!0)},vt=(t,i,a)=>{const{likedIds:e,onPlaySong:s}=a;t.innerHTML=`
  ...
  `).join(""),t.querySelectorAll(".library-item").forEach(s=>{s.addEventListener("click",()=>{const n=s.dataset.playlistId;e(n)})})},xt=(t,i,a)=>{const{onShowLogin:e,onShowSignup:s,onLogout:n}=a;if(i){t.innerHTML=`
    ...
    `,t.querySelector("#btn-show-signup-inline").addEventListener("click",s),t.querySelector("#btn-show-login-inline").addEventListener("click",e)},b=new q;let g={currentUser:null,likedSongIds:[],userPlaylists:[],currentView:"home",currentViewId:null,searchQuery:"",activePlaylistId:null};const o={mainView:document.getElementById("main-view"),libraryPlaylists:document.getElementById("library-playlists"),authControls:document.getElementById("auth-controls"),navHome:document.getElementById("nav-home"),navSearch:document.getElementById("nav-search"),searchBarWrapper:document.getElementById("search-bar-wrapper"),searchInput:document.getElementById("search-input"),createPlaylistBtn:document.getElementById("create-playlist-btn"),authModal:document.getElementById("auth-modal"),authModalClose:document.getElementById("auth-modal-close"),tabLogin:document.getElementById("tab-login"),tabSignup:document.getElementById("tab-signup"),formLogin:document.getElementById("form-login"),formSignup:document.getElementById("form-signup"),loginError:document.getElementById("login-error"),signupError:document.getElementById("signup-error"),playerTrackInfo:document.getElementById("player-track-info"),playerLikeBtn:document.getElementById("player-like-btn"),playerShuffle:document.getElementById("player-shuffle"),playerPrev:document.getElementById("player-prev"),playerPlayPause:document.getElementById("player-play-pause"),playerNext:document.getElementById("player-next"),playerRepeat:document.getElementById("player-repeat"),playerMute:document.getElementById("player-mute"),playerTimeCurrent:document.getElementById("player-time-current"),playerTimeTotal:document.getElementById("player-time-total"),progressBarWrapper:document.getElementById("progress-bar-wrapper"),progressBarFill:document.getElementById("progress-bar-fill"),progressThumb:document.getElementById("progress-thumb"),volumeBarWrapper:document.getElementById("volume-bar-wrapper"),volumeBarFill:document.getElementById("volume-bar-fill"),volumeThumb:document.getElementById("volume-thumb")};let P=null;document.addEventListener("DOMContentLoaded",()=>{wt(),St(),kt(),k("home")});async function wt(){try{const t=await fetch("/api/auth/me");if(t.ok){const i=await t.json();g.currentUser=i.user,await Promise.all([V(),T()])}}catch(t){console.error("Session check failed",t)}finally{R()}}async function V(){if(g.currentUser)try{const t=await fetch("/api/liked/ids");t.ok&&(g.likedSongIds=await t.json())}catch(t){console.error("Error fetching liked song IDs",t)}}async function T(){if(g.currentUser)try{const t=await fetch("/api/playlists");t.ok&&(g.userPlaylists=await t.json(),Z())}catch(t){console.error("Error fetching user playlists",t)}}async function k(t,i=null,a={}){g.currentView=t,g.currentViewId=i,o.navHome.classList.toggle("active",t==="home"),o.navSearch.classList.toggle("active",t==="search"),o.searchBarWrapper.style.display=t==="search"?"flex":"none",o.mainView.innerHTML='<div style="height: 60vh; display: flex; align-items: center; justify-content: center; font-size: 14px; color: var(--color-text-muted);">Loading...</div>';try{if((t==="liked"||t==="playlist")&&!g.currentUser){o.mainView.innerHTML=`
      ...
      `,o.mainView.querySelector("#btn-view-auth-trigger").addEventListener("click",_);return}const e={onPlaySong:A,onToggleLike:et,likedIds:g.likedSongIds,onNavigate:k,onOpenPlaylistMenu:$t,onRemoveSongFromPlaylist:It,onEditPlaylist:Lt,onDeletePlaylist:Pt};if(t==="home"){const[s,n,p]=await Promise.all([fetch("/api/songs/albums"),fetch("/api/songs/artists"),fetch("/api/songs")]),y=await s.json(),x=await n.json(),l=await p.json();yt(o.mainView,{albums:y,artists:x,songs:l,likedIds:g.likedSongIds},e)}else if(t==="search")if(!g.searchQuery)J(o.mainView,null,"",e);else{const n=await(await fetch(`/api/songs/search?q=${encodeURIComponent(g.searchQuery)}`)).json();J(o.mainView,n,g.searchQuery,e)}else if(t==="album"){const s=await fetch(`/api/songs/albums/${i}`);if(!s.ok)throw new Error("Album not found");const n=await s.json();mt(o.mainView,n,e),a.autoPlay&&n.songs.length>0&&A(n.songs[0],n.songs)}else if(t==="artist"){const s=await fetch(`/api/songs/artists/${i}`);if(!s.ok)throw new Error("Artist not found");const n=await s.json();ht(o.mainView,n,e),a.autoPlay&&n.songs.length>0&&A(n.songs[0],n.songs)}else if(t==="playlist"){const s=await fetch(`/api/playlists/${i}`);if(!s.ok)throw new Error("Playlist not found");const n=await s.json();ft(o.mainView,n,e),a.autoPlay&&n.songs.length>0&&A(n.songs[0],n.songs)}else if(t==="liked"){const n=await(await fetch("/api/liked")).json();vt(o.mainView,n,e)}tt()}catch(e){console.error("Error rendering view",e),o.mainView.innerHTML=`
    ...
    `}}function St(){o.navHome.addEventListener("click",t=>{t.preventDefault(),k("home")}),o.navSearch.addEventListener("click",t=>{t.preventDefault(),k("search")}),o.searchInput.addEventListener("input",t=>{g.searchQuery=t.target.value.trim(),k("search")}),o.createPlaylistBtn.addEventListener("click",async()=>{if(!g.currentUser){_();return}try{const t=`My Playlist #${g.userPlaylists.length+1}`,i=await fetch("/api/playlists",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t,description:"Created with love."})});if(i.ok){const a=await i.json();await T(),k("playlist",a.id)}}catch(t){console.error("Error creating playlist",t)}}),document.addEventListener("click",()=>{D()}),o.authModalClose.addEventListener("click",F),o.tabLogin.addEventListener("click",()=>z("login")),o.tabSignup.addEventListener("click",()=>z("signup")),o.formLogin.addEventListener("submit",Tt),o.formSignup.addEventListener("submit",Bt)}function Z(){bt(o.libraryPlaylists,g.userPlaylists,g.currentView==="playlist"?g.currentViewId:null,t=>k("playlist",t))}function R(){xt(o.authControls,g.currentUser,{onShowLogin:()=>_("login"),onShowSignup:()=>_("signup"),onLogout:Mt}),g.currentUser?o.createPlaylistBtn.style.display="flex":(o.libraryPlaylists.innerHTML=`
      <div class="auth-required-message">
        <p>Log in to create and view playlists</p>
      </div>
    `,g.likedSongIds=[],g.userPlaylists=[])}function kt(){W(o.volumeBarWrapper,t=>{o.volumeBarFill.style.width=`${t}%`,o.volumeThumb&&(o.volumeThumb.style.left=`${t}%`),b.setVolume(t/100),Q(t/100)}),W(o.progressBarWrapper,t=>{b.seek(t)}),o.playerPlayPause.addEventListener("click",()=>b.togglePlay()),o.playerNext.addEventListener("click",()=>b.next()),o.playerPrev.addEventListener("click",()=>b.prev()),o.playerShuffle.addEventListener("click",()=>{const t=b.toggleShuffle();o.playerShuffle.classList.toggle("active",t)}),o.playerRepeat.addEventListener("click",()=>{const t=b.toggleRepeat();o.playerRepeat.classList.toggle("active",t!=="none");const i=o.playerRepeat.querySelector("i");t==="track"||t==="playlist"?(o.playerRepeat.style.color="var(--color-spotify-green)",i.className="bx bx-repeat"):(o.playerRepeat.style.color="",i.className="bx bx-repeat")}),o.playerMute.addEventListener("click",()=>{const t=b.toggleMute(),i=o.playerMute.querySelector("i");if(t)i.className="bx bx-volume-mute",o.volumeBarFill.style.width="0%",o.volumeThumb&&(o.volumeThumb.style.left="0%");else{const a=b.volume*100;o.volumeBarFill.style.width=`${a}%`,o.volumeThumb&&(o.volumeThumb.style.left=`${a}%`),Q(b.volume)}}),o.playerLikeBtn.addEventListener("click",()=>{if(b.currentIndex===-1)return;const t=b.playlist[b.currentIndex];et(t.id)}),b.onTrackChange=t=>{o.playerTrackInfo.innerHTML=`
    ...
    `,o.playerTrackInfo.querySelector("#bottom-track-artist").addEventListener("click",()=>{k("artist",t.artist_id)}),o.playerLikeBtn.disabled=!g.currentUser,it(t.id),tt()},b.onPlayStateChange=t=>{const i=o.playerPlayPause.querySelector("i");i.className=t?"bx bx-pause-circle":"bx bx-play-circle"},b.onTimeUpdate=(t,i,a)=>{o.playerTimeCurrent.textContent=q.formatTime(t),o.playerTimeTotal.textContent=q.formatTime(i),o.progressBarFill.style.width=`${a}%`,o.progressThumb&&(o.progressThumb.style.left=`${a}%`)}}function tt(){if(b.currentIndex===-1||b.playlist.length===0)return;const t=b.playlist[b.currentIndex];document.querySelectorAll(".songs-table tbody tr").forEach(a=>{a.classList.remove("active-song");const e=a.querySelector(".td-index");if(e){parseInt(a.dataset.songId),e.style.color="";const s=e.getAttribute("data-original-index")||e.textContent;e.textContent=s}});const i=document.querySelector(`.songs-table tbody tr[data-song-id="${t.id}"]`);if(i){i.classList.add("active-song");const a=i.querySelector(".td-index");a&&(a.getAttribute("data-original-index")||a.setAttribute("data-original-index",a.textContent),a.style.color="var(--color-spotify-green)",a.innerHTML='<i class="bx bxs-volume-full"></i>')}}function A(t,i){b.playTrack(t,i)}async function et(t){if(!g.currentUser){_();return}const i=g.likedSongIds.includes(t),a=i?"DELETE":"POST",e=i?`/api/liked/${t}`:"/api/liked";try{(await fetch(e,{method:a,headers:{"Content-Type":"application/json"},body:i?null:JSON.stringify({songId:t})})).ok&&(i?g.likedSongIds=g.likedSongIds.filter(n=>n!==t):g.likedSongIds.push(t),Et(t,!i),b.currentIndex!==-1&&b.playlist[b.currentIndex].id===t&&it(t),g.currentView==="liked"&&k("liked"))}catch(s){console.error("Error toggling like",s)}}function Et(t,i){document.querySelectorAll(`[data-song-id="${t}"][data-action="like"]`).forEach(e=>{e.classList.toggle("liked",i);const s=e.querySelector("i");s&&(s.className=i?"bx bxs-heart":"bx bx-heart")})}function it(t){const i=g.likedSongIds.includes(t);o.playerLikeBtn.classList.toggle("liked",i);const a=o.playerLikeBtn.querySelector("i");a&&(a.className=i?"bx bxs-heart":"bx bx-heart")}async function Lt(t,i,a){try{const e=await fetch(`/api/playlists/${t}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:i,description:a})});if(e.ok)await T(),k("playlist",t);else{const s=await e.json();alert(s.error||"Failed to update playlist")}}catch(e){console.error("Error updating playlist details",e)}}async function Pt(t){try{(await fetch(`/api/playlists/${t}`,{method:"DELETE"})).ok&&(await T(),k("home"))}catch(i){console.error("Error deleting playlist",i)}}async function It(t){const i=g.currentViewId;try{(await fetch(`/api/playlists/${i}/songs/${t}`,{method:"DELETE"})).ok&&k("playlist",i)}catch(a){console.error("Error removing song from playlist",a)}}function $t(t,i){if(!g.currentUser){_();return}if(D(),g.userPlaylists.length===0){alert("Please create a playlist first in the sidebar library!");return}P=document.createElement("div"),P.className="dropdown-menu show";const a=t.getBoundingClientRect();P.style.position="fixed",P.style.left=`${a.left-130}px`,P.style.top=`${a.top+window.scrollY+28}px`,P.innerHTML=`
    ...
    `).join("")}
  `,P.querySelectorAll(".dropdown-item").forEach(e=>{e.addEventListener("click",async s=>{s.stopPropagation();const n=e.dataset.playlistId;await _t(n,i),D()})}),document.body.appendChild(P)}async function _t(t,i){try{const a=await fetch(`/api/playlists/${t}/songs`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({songId:i})});if(a.ok)alert("Track added to playlist successfully!");else{const e=await a.json();alert(e.error||"Song already exists in this playlist.")}}catch(a){console.error("Error mapping song to playlist",a)}}function D(){P&&(P.remove(),P=null)}function _(t="login"){o.authModal.classList.add("show"),z(t)}function F(){o.authModal.classList.remove("show"),o.loginError.textContent="",o.signupError.textContent="",o.formLogin.reset(),o.formSignup.reset()}function z(t){o.tabLogin.classList.toggle("active",t==="login"),o.tabSignup.classList.toggle("active",t==="signup"),o.formLogin.classList.toggle("hidden",t!=="login"),o.formSignup.classList.toggle("hidden",t!=="signup")}async function Tt(t){t.preventDefault();const i=document.getElementById("login-email").value,a=document.getElementById("login-password").value;o.loginError.textContent="";try{const e=await fetch("/api/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,password:a})});if(e.ok){const s=await e.json();g.currentUser=s.user,F(),await Promise.all([V(),T()]),R(),k(g.currentView,g.currentViewId)}else{const s=await e.json();o.loginError.textContent=s.error||"Failed to login"}}catch(e){console.error("Login error",e),o.loginError.textContent="Server connection failed."}}async function Bt(t){t.preventDefault();const i=document.getElementById("signup-username").value.trim(),a=document.getElementById("signup-email").value.trim(),e=document.getElementById("signup-password").value;if(o.signupError.textContent="",e.length<6){o.signupError.textContent="Password must be at least 6 characters.";return}try{const s=await fetch("/api/auth/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:i,email:a,password:e})});if(s.ok){const n=await s.json();g.currentUser=n.user,F(),await Promise.all([V(),T()]),R(),k(g.currentView,g.currentViewId)}else{const n=await s.json();o.signupError.textContent=n.error||"Failed to sign up"}}catch(s){console.error("Registration error",s),o.signupError.textContent="Server connection failed."}}async function Mt(){try{(await fetch("/api/auth/logout",{method:"POST"})).ok&&(g.currentUser=null,g.likedSongIds=[],g.userPlaylists=[],(g.currentView==="playlist"||g.currentView==="liked")&&(b.audio.pause(),b.isPlaying=!1,b.onPlayStateChange(!1)),R(),Z(),k("home"))}catch(t){console.error("Logout error",t)}}function W(t,i){let a=!1;const e=y=>{const x=t.getBoundingClientRect(),m=(y.clientX||y.touches&&y.touches[0].clientX)-x.left,h=x.width;return Math.max(0,Math.min(100,m/h*100))},s=y=>{a=!0,n(y)},n=y=>{if(!a)return;const x=e(y);i(x)},p=()=>{a=!1};t.addEventListener("mousedown",s),window.addEventListener("mousemove",n),window.addEventListener("mouseup",p),t.addEventListener("touchstart",s,{passive:!0}),window.addEventListener("touchmove",n,{passive:!0}),window.addEventListener("touchend",p)}function Q(t){const i=o.playerMute.querySelector("i");t===0?i.className="bx bx-volume-mute":t<.3?i.className="bx bx-volume":t<.7?i.className="bx bx-volume-low":i.className="bx bx-volume-full"}
